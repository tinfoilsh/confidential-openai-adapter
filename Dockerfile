...
RUN CGO_ENABLED=0 go build -trimpath -ldflags='-s -w -buildid=' -o /confidential-tinfoil-adapter .

FROM gcr.io/distroless/static-debian12:nonroot@sha256:1b7b9f0f0e0a1d2155f531db587cc48ec26aaf97ab64364225f5bf18a054e66a
COPY --from=build /confidential-tinfoil-adapter /confidential-tinfoil-adapter
EXPOSE 8443
ENTRYPOINT ["/confidential-tinfoil-adapter"]
